...
import PainelFinances from "./components/panel-finances";
            ...
            <div className="flex items-center gap-2 px-4">
              ...
              <Breadcrumb>
                <BreadcrumbList>
                  ...
                  <BreadcrumbItem>
                    <BreadcrumbPage>Anual</BreadcrumbPage>
                  </BreadcrumbItem>
                </BreadcrumbList>
              </Breadcrumb>
            </div>
          </header>
          <PainelFinances emailBusiness={emailBusiness as string}></PainelFinances>
        </SidebarInset>
      </SidebarProvider>
    )
  }
